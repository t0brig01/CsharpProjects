        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 17; i++)
            {
                for (int j = 0; j < 17; j++)
                {
                    ...
                    int[] temp3 = a[j+2];
                    int[] temp4 = a[j+3];
                    Console.WriteLine(temp1[i]+" , " + temp2[i+1] + " , " + temp3[i+2] + " , " + temp4[i+3] + " , ");
                    prod = temp1[i] * temp2[i + 1] * temp3[i + 2] * temp4[i + 3];
                    if (maxProd < prod)
                    {
                        maxProd = prod;
                    }
                }
                Console.WriteLine("maxProd = {0}\t i = {1}",maxProd,i);
            }
            ...
            for (int i = 0; i < 20; i++)
            {
                for (int j = 0; j < 17; j++)
                {
                    ...
                    int[] temp3 = a[j + 2];
                    int[] temp4 = a[j + 3];
                    prod = temp1[i] * temp2[i] * temp3[i] * temp4[i];
                    Console.WriteLine(temp1[i] + " , " + temp2[i] + " , " + temp3[i] + " , " + temp4[i] + " , ");
                    if (maxProd < prod)
                    {
                        maxProd = prod;
                    }
            ...
            for (int i = 0; i < 17; i++)
            {
                ...
                {
                    int[] temp = a[j];
                    prod = temp[i] * temp[i + 1] * temp[i + 2] * temp[i + 3];
                    Console.WriteLine(temp[i] + " , " + temp[i + 1] + " , " + temp[i + 2] + " , " + temp[i + 3] + " , ");
                    if (maxProd < prod)
                    {
                        maxProd = prod;
                    }
